...
<div>
<h1 class="mb-3">Editar post -  {{$post->titulo}}</h1>
...
@endif
  <form method="POST" enctype="multipart/form-data" action="{{action('BlogController@update',$id)}}">
    @csrf
    <input type="hidden" name="_method" value="PATcH">
    <div class="form-group mb-3">
        <label for="titulo">Título</label>
        <input type="text" class="form-control" value="{{$post->titulo}}"  name="titulo" placeholder="Digite o Título" required>
    </div>
    <div class="form-group mb-3">
        <label for="descricao">Descrição</label>
        <textarea class="form-control" id="descricao" name="descricao" rows="3" placeholder="Digite uma breve descrição " required>{{$post->descricao}}</textarea>
    </div>
     <div class="form-group mb-3">
        <label for="descricao">Descrição topo</label>
        <textarea class="form-control" id="descricao" name="descricao_1" rows="3" placeholder="Digite uma breve descrição " required>{{$post->descricao_1}}</textarea>
    </div>
