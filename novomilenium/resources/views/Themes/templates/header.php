<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco_navbar ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
	    	<a class="navbar-brand" href="index.php"><img src="images/home/logo2.jpg"></a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item"><a href="docentes.php" class="nav-link">Docentes</a></li>
	        	<li class="nav-item"><a href="cursos.php" class="nav-link">Cursos</a></li>
	        	<li class="nav-item"><a href="pricing.html" class="nav-link">Matriculas</a></li>
